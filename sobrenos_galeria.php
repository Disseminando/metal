...
<!DOCTYPE html>
<html>
<body style="margin:0;padding:0;font-family:Arial, Verdana;background-color:#fff;">
    <script type="text/javascript" src="assets/galeria/js/jquery-1.9.1.min.js"></script>
    <script type="text/javascript" src="assets/galeria/js/jssor.slider.min.js"></script>
    ...
    <div style="position:relative;top:0;left:0;width:100%;overflow:hidden;">
        ...
        <div id="slider1_container" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 980px; height: 380px;">
            ...
            <div data-u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px;  height: 380px; overflow: hidden;">
                <div>
                    <img data-u="image" src="assets/galeria/img/gallery/980x380/caminhao01.jpg" />
                </div>
                <div>
                    <img data-u="image" src="assets/galeria/img/gallery/980x380/caminhao02.jpg" />
                </div>
                <div>
                    <img data-u="image" src="assets/galeria/img/gallery/980x380/caminhao03.jpg" />
                </div>
                <div>
                    <img data-u="image" src="assets/galeria/img/gallery/980x380/caminhao04.jpg" />
                </div>
            </div>
